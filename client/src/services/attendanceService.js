...
export const listAttendance = async (params = {}) => (await api.get('/attendance', { params })).data
export const getMyAttendance = async (params = {}) => (await api.get('/attendance/mine', { params })).data
